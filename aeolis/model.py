...
class AeoLiS(IBmi):
    ...
    def get_var(self, var:str) -> Union[np.array, int, float, str, list]:
    ...
    def set_var(self, var:str, val:Union[np.array, int, float, str, list]) -> None:
    ...
    def set_var_index(self, i:int, val:np.array) -> None:
...
class AeoLiSRunner(AeoLiS):
    ...
    def get_statistic(self, var:str, stat:str='avg') -> Union[np.array, None]:
    ...
    def get_var(self, var:str, clear:bool=True) -> Union[np.array, int, float, str, list]:
...
class WindGenerator():
    ...
    def __getitem__(self, s:int)-> np.array:
        """
