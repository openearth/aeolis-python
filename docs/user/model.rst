...
.. figure:: /images/sediment_supply_figure.png
   ...
   represents the final measured field profile for this case study. The evolution of shoreline position (e), shoreline 
   elevation (f), dune toe elevation (g), beach slope (h) and change in dune volume through the simulation time (i) are 
   shown below.